<?php 
	...
	if(isset($_SESSION['order_no']) && isset($_SESSION['total_amt']) && isset($_SESSION['products']) && isset($_SESSION['pickup_date'])){
						...
						<ul class='product-list'>
							<?php foreach ($products as $product) : ?>
								<li class='product-item'>
									...
									<p class='pickup-date'>Pickup Date: <?php echo $pickup_date; ?></p>
								</li>
							<?php endforeach; ?>
						</ul>
